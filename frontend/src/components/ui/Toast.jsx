  ...
  return (
    <div
      className={`
        ...
        ${isVisible ? 'animate-slideIn opacity-100' : 'animate-slideOut opacity-0'}
      `}
      role="alert"
    >
      {/* Icon */}
      ...
      <button
        onClick={handleClose}
        className="flex-shrink-0 text-gray-400 hover:text-white transition-colors focus:outline-none focus:ring-2 focus:ring-yellow-400 rounded"
